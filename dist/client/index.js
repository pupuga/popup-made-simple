...
const Popup = ({
  ...
  const closeWindow = () => {
    setClose(true);
    _Cookie__WEBPACK_IMPORTED_MODULE_3__["default"].set(`${_settings__WEBPACK_IMPORTED_MODULE_0__["default"].postType}-${el.id}-${el.date}`, true, 365);
  };
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    const importCss = async () => {
      if (el?.meta?._popup_made_simple_form_style[0] === "1") {
        await __webpack_require__.e(/*! import() */ "src_client_form_scss").then(__webpack_require__.bind(__webpack_require__, /*! ./form.scss */ "./src/client/form.scss"));
      }
    };
    importCss();
  }, []);
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    ...
    const time = setTimeout(() => {
      ...
      if (typeof wpcf7 !== "undefined") {
        formInit = setTimeout(() => {
          const formObject = document.querySelector(`.${_settings__WEBPACK_IMPORTED_MODULE_0__["default"].postType}-${el.id} .wpcf7-form`);
          if (formObject !== null) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (close === false) {
      const button = document.querySelector(`.${_settings__WEBPACK_IMPORTED_MODULE_0__["default"].postType}-${el.id} .accept-action`);
      if (button !== null) {
...
/******/ 			return "" + chunkId + ".js?ver=" + {"src_client_index_scss":"be903a860fc497e59493","src_client_form_scss":"d3291911f1d608246ff2"}[chunkId] + "";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "popup-made-simple:";
...
/******/ 			var cssChunks = {"src_client_index_scss":1,"src_client_form_scss":1};
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkpopup_made_simple"] = globalThis["webpackChunkpopup_made_simple"] || [];
...
/* harmony import */ var _App__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./App */ "./src/client/App.jsx");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react/jsx-runtime */ "react/jsx-runtime");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__);
...
const renderApp = () => {
  const id = _settings__WEBPACK_IMPORTED_MODULE_2__["default"].postType;
  let rootElement = document.getElementById(id);
  if (!rootElement) {
    (async () => await __webpack_require__.e(/*! import() */ "src_client_index_scss").then(__webpack_require__.bind(__webpack_require__, /*! ./index.scss */ "./src/client/index.scss")))();
